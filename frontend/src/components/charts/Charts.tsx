...
const CHART_COLORS = ["#6366f1","#10b981","#f59e0b","#ef4444","#3b82f6","#8b5cf6","#06b6d4"];
  ...
  return (
    <ResponsiveContainer width="100%" height={height}>
      <AreaChart data={data} margin={{ top: 5, right: 10, left: -10, bottom: 5 }}>
        ...
        <Area type="monotone" dataKey="total_energy_kwh" stroke="#3b82f6" fill="url(#elecGrad)" strokeWidth={2} name="Energy (kWh)" />
